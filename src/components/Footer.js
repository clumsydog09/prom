...
const Footer = () => {
  return (
    <div className='w-full h-screen bg-[#010613] pb-20 lg:flex lg:flex-col lg:justify-center'>
      ...
      <a href="https://iecsemanipal.com/" className='flex justify-center'>
        <Image src={footer_back} alt='footer-back'></Image>
      </a>
      <div className='flex flex-row space-x-20 justify-center items-center'>
        <a href="https://www.instagram.com/iecsemanipal/">
          <Image src={insta} className='h-8 w-8' alt='insta'></Image>
        </a>
        <a href="https://www.instagram.com/iecsemanipal/">
          <Image src={linkedin} className='h-8 w-8' alt='linkedin'></Image>
        </a>
      </div>
    </div>
  )
